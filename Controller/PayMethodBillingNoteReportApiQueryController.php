...
/**
 * PayMethod BillingNote Report Api Controller
 *
 * @Rest\Version("1.0")
 * @Rest\Route("/api/report/pay-method-billing-note")
 * @Rest\View(serializerEnableMaxDepthChecks=true)
 */
class PayMethodBillingNoteReportApiQueryController
{
    /**
    ...
    /**
     * PayMethodBillingNoteReportApiQueryController constructor.
     */
    ...
    public function payMethodBillingNoteSummaryExportAction(ServerRequestInterface $request, string $format)
    {
        ...
        switch(strtolower($format)) {
            case 'pdf':
                $view = $this->templating->render('@ErpReport/pdf/pay-method-billing-note-report.pdf.twig', [
                    'profile' => $profile,
                    'model' => $data,
            ...
            case 'xlsx':
                ...
                $sheet->setCellValue('A1', 'รายงานกำหนดการรับเงิน โดย ใบวางบิล/ใบแจ้งหนี้ (Accept by BN-FI)');
                ...
                $fileName = 'RP-FI-IN-BN-Accept_rev.2.1.0_'.date('Ymd_His', time()).'.xlsx';
