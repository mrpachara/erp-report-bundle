...
/**
 * PayMethod Revenue Report Api Controller
 *
 * @Rest\Version("1.0")
 * @Rest\Route("/api/report/pay-method-revenue")
 * @Rest\View(serializerEnableMaxDepthChecks=true)
 */
class PayMethodRevenueReportApiQueryController
{
/*
...
/** @var \Erp\Bundle\ReportBundle\Domain\CQRS\PayMethodRevenueReportQuery */
    ...
    /**
     * PayMethodRevenueReportApiQueryController constructor.
     * @param \Erp\Bundle\ReportBundle\Domain\CQRS\PayMethodRevenueReportQuery $domainQuery
     */
     ...
     */
    public function payMethodRevenueSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
        ...
        $view = $this->templating->render('@ErpReport/pdf/pay-method-revenue-report.pdf.twig', [
            'profile' => $profile,
            'model' => $data,
