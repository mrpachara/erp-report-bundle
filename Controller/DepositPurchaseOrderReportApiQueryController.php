...
/** @var \Erp\Bundle\ReportBundle\Domain\CQRS\DepositPurchaseOrderReportQuery */
     ...
     * @param \Erp\Bundle\ReportBundle\Domain\CQRS\DepositPurchaseOrderReportQuery $domainQuery
     */
     ...
     */
    public function depositPurchaseOrderSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
