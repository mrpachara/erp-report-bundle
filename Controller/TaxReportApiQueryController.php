...
/** @var \Erp\Bundle\ReportBundle\Domain\CQRS\TaxReportQuery */
    ...
    public function __construct(
        \Erp\Bundle\ReportBundle\Domain\CQRS\TaxReportQuery $domainQuery,
     ...
     */
    public function taxSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
        $data = $this->domainQuery->taxSummary($request->getQueryParams(), $filterDetail);
        ...
        $view = $this->templating->render('@ErpReport/pdf/tax-report.pdf.twig', [
            'profile' => $profile,
            'model' => $data,
