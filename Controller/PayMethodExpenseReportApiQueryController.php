...
/** @var \Erp\Bundle\ReportBundle\Domain\CQRS\PayMethodExpenseReportQuery */
     ...
     * @param \Erp\Bundle\ReportBundle\Domain\CQRS\PayMethodExpenseReportQuery $domainQuery
     */
     ...
     */
    public function payMethodExpenseSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
