...
/**
 * PurchaseOrer Vat Report Api Controller
 *
 * @Rest\Version("1.0")
 * @Rest\Route("/api/report/vat-purchase-order")
 * @Rest\View(serializerEnableMaxDepthChecks=true)
 */
class PurchaseOrderVatReportApiQueryController
{
    /**
    ...
    /**
     * PurchaseOrderVatReportQueryController constructor.
     */
     ...
     */
    public function vatPurchaseOrderSummaryExportAction(ServerRequestInterface $request, string $format)
    {
        $filterDetail = [];
