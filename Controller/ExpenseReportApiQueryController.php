...
/** @var \Erp\Bundle\ReportBundle\Domain\CQRS\ExpenseReportQuery */
     ...
     * @param \Erp\Bundle\ReportBundle\Domain\CQRS\ExpenseReportQuery $domainQuery
     */
     ...
     */
    public function expenseSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
     ...
     */
    public function expenseCostSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
        $data = $this->domainQuery->expenseSummary($request->getQueryParams(), $filterDetail);
        ...
        $view = $this->templating->render('@ErpReport/pdf/expense-cost-report.pdf.twig', [
            'profile' => $profile,
            'model' => $data,
            'filterDetail' => $filterDetail,
        ]);
