...
/** @var \Erp\Bundle\ReportBundle\Domain\CQRS\WarrantyExpenseReportQuery */
     ...
     * @param \Erp\Bundle\ReportBundle\Domain\CQRS\WarrantyExpenseReportQuery $domainQuery
     */
     ...
     */
    public function warrantyExpenseSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
