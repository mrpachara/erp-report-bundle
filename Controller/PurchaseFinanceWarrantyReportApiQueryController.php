...
/**
 * Purchase Warranty Report Api Controller
 *
 * @Rest\Version("1.0")
 * @Rest\Route("/api/report/warranty-purchase")
 * @Rest\View(serializerEnableMaxDepthChecks=true)
 */
class PurchaseFinanceWarrantyReportApiQueryController
{
    ...
    /**
     * PurchaseFinanceWarrantyReportApiQueryController constructor.
     */
     ...
     * @Rest\Get("")
     */
    public function summarizeWarrantyAction(ServerRequestInterface $request)
    {
        return [
     ...
     */
    public function summarizeWarrantyExportAction(ServerRequestInterface $request, string $format)
    {
        $filterDetail = [];
