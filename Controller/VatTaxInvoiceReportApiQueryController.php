...
class VatTaxInvoiceReportApiQueryController
{
     ...
     * @param \Erp\Bundle\ReportBundle\Domain\CQRS\VatTaxInvoiceReportQuery $domainQuery
     */
     ...
     */
    public function vatTaxInvoiceSummaryExportAction(ServerRequestInterface $request)
    {
        $filterDetail = [];
