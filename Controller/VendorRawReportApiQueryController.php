    ...
    public function individualExportAction(ServerRequestInterface $request, string $format)
    {
        ...
        switch (strtolower($format)) {
            ...
            case 'xlsx':
                ...
                //หัวเอกสาร
                $sheet->setCellValue('A1', 'รายงานข้อมูลผู้จำหน่ายประเภทบุคคลธรรมดา (INDIVIDUAL VENDOR REPORT)');
                //เริ่มเอกสาร
    ...
    public function corporateExportAction(ServerRequestInterface $request, string $format)
    {
        ...
        switch (strtolower($format)) {
            ...
            case 'xlsx':
                ...
                //หัวเอกสาร
                $sheet->setCellValue('A1', 'รายงานข้อมูลผู้จำหน่ายประเภทนิติบุคคล (CORPORATE VENDOR REPORT)');
                //เริ่มเอกสาร
                $sheet->setCellValue('A8', 'ลำดับ');
                $sheet->setCellValue('B8', 'รหัส');
