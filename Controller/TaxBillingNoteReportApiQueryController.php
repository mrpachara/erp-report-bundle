...
class TaxBillingNoteReportApiQueryController
{
     ...
     */
    public function taxBillingNoteSummaryExportAction(ServerRequestInterface $request, string $format)
    {
        $filterDetail = [];
        ...
        switch(strtolower($format)) {
            ...
            case 'xlsx':
                ...
                $sheet->setCellValue('A1', 'รายงานภาษีหัก ณ ที่จ่าย โดย ใบวางบิล/ใบแจ้งหนี้ (Tax by BN-FI)');
                ...
                $fileName = 'RP-FI-IN-BN-Tax_rev.2.1.0_'.date('Ymd_His', time()).'.xlsx';
