        ...
        switch(strtolower($format)) {
            ...
            case 'xlsx':
                ...
                foreach($data as $item) {
                    $itemStartRow = $row;
                    $sheet->setCellValue("A{$row}", 'รายงานงบประมาณโครงการ โดย ใบขอซื้อ (PJ-Budget by PU)');
                    $row++;
                    $labelRow = $row;
                ...
                $fileName = 'RP-MT-PJ-Budget-PU_'."{$item['projectCode']}-{$item['name']}".'_'.date('Ymd_His', time()).'.xlsx';
