...
/**
 * Purchase PayMethod Report Api Controller
 *
 * @Rest\Version("1.0")
 * @Rest\Route("/api/report/pay-method-purchase")
 * @Rest\View(serializerEnableMaxDepthChecks=true)
 */
class PurchaseFinancePayMethodReportApiQueryController
{
    /**
     ...
     * @Rest\Get("")
     */
    public function summarizePayMethodAction(ServerRequestInterface $request)
    {
        return [
