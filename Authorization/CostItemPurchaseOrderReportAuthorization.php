...
class CostItemPurchaseOrderReportAuthorization extends AbstractReportAuthorization
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return $this->authorizationChecker->isGranted('ROLE_REPORT_MT_CI_QUANTITY_PO');
    }
