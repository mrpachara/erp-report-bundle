...
class CostItemGoodsReceiptReportAuthorization extends AbstractReportAuthorization
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        return $this->authorizationChecker->isGranted('ROLE_REPORT_MT_CI_QUANTITY_GR');
    }
