...
use Erp\Bundle\ReportBundle\Domain\CQRS\TaxRevenueReportQuery as QueryInterface;

class TaxRevenueReportQueryService implements QueryInterface
{
    ...
    function taxRevenueQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->taxRevenueQueryBuilder('_entity');
