...
use Erp\Bundle\ReportBundle\Domain\CQRS\TaxBillingNoteReportQuery as QueryInterface;

class TaxBillingNoteReportQueryService implements QueryInterface
{
    ...
    {
        $filterDetail = [];
        $qb = $this->taxBillingNoteQueryBuilder('_entity');
