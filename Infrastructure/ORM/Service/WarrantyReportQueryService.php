...
use Erp\Bundle\ReportBundle\Domain\CQRS\WarrantyReportQuery as QueryInterface;

class WarrantyReportQueryService implements QueryInterface
{
    ...
    function warrantyQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->warrantyQueryBuilder('_entity');
