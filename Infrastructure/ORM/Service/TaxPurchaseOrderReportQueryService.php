...
use Erp\Bundle\ReportBundle\Domain\CQRS\TaxPurchaseOrderReportQuery as QueryInterface;

class TaxPurchaseOrderReportQueryService implements QueryInterface
{
    ...
    function taxPurchaseOrderQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->taxPurchaseOrderQueryBuilder('_entity');
