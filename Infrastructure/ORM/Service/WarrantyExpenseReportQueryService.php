...
use Erp\Bundle\ReportBundle\Domain\CQRS\WarrantyExpenseReportQuery as QueryInterface;

class WarrantyExpenseReportQueryService implements QueryInterface
{
    ...
    function warrantyExpenseQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->warrantyExpenseQueryBuilder('_entity');
