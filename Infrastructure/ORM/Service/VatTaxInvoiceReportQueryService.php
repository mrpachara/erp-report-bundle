...
use Erp\Bundle\ReportBundle\Domain\CQRS\VatTaxInvoiceReportQuery as QueryInterface;

class VatTaxInvoiceReportQueryService implements QueryInterface
{
    ...
    function vatTaxInvoiceQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->vatTaxInvoiceQueryBuilder('_entity');
