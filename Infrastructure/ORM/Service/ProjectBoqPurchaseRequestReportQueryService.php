                ...
                foreach($result['cost']['columns'] as $column) {
                    if($column['id'] !== null) {
                        $costData['costs'][] = [
                            ...
                            'cost' => (double)$boq->getBudgets()[$column['id']]->cost['request']['approved'] + $boq->getBudgets()[$column['id']]->cost['request']['nonapproved']
                            + $boq->getBudgets()[$column['id']]->cost['order']['approved'] + $boq->getBudgets()[$column['id']]->cost['order']['nonapproved']
                            + $boq->getBudgets()[$column['id']]->cost['expense']['approved'] + $boq->getBudgets()[$column['id']]->cost['expense']['nonapproved'],
                            'remain' => (double)($boq->getBudgets()[$column['id']]->getBudget() - ($boq->getBudgets()[$column['id']]->cost['request']['approved'] + $boq->getBudgets()[$column['id']]->cost['request']['nonapproved']
                                + $boq->getBudgets()[$column['id']]->cost['order']['approved'] + $boq->getBudgets()[$column['id']]->cost['order']['nonapproved']
                                + $boq->getBudgets()[$column['id']]->cost['expense']['approved'] + $boq->getBudgets()[$column['id']]->cost['expense']['nonapproved'])),
                        ];
                    }
