...
use Erp\Bundle\ReportBundle\Domain\CQRS\DeliveryNoteReportQuery as QueryInterface;

class DeliveryNoteReportQueryService implements QueryInterface
{
    ...
    function deliveryNoteQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->deliveryNoteQueryBuilder('_entity');
