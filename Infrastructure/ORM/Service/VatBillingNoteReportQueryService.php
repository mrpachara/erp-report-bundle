...
use Erp\Bundle\ReportBundle\Domain\CQRS\VatBillingNoteReportQuery as QueryInterface;

class VatBillingNoteReportQueryService implements QueryInterface
{
    ...
    {
        $filterDetail = [];
        $qb = $this->vatBillingNoteQueryBuilder('_entity');
