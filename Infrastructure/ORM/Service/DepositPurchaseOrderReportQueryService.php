...
use Erp\Bundle\ReportBundle\Domain\CQRS\DepositPurchaseOrderReportQuery as QueryInterface;

class DepositPurchaseOrderReportQueryService implements QueryInterface
{
    ...
    function depositPurchaseOrderQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->depositPurchaseOrderQueryBuilder('_entity');
