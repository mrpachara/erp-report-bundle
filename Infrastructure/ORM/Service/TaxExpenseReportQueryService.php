...
use Erp\Bundle\ReportBundle\Domain\CQRS\TaxExpenseReportQuery as QueryInterface;

class TaxExpenseReportQueryService implements QueryInterface
{
    ...
    function taxExpenseQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->taxExpenseQueryBuilder('_entity');
