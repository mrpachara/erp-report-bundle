...
use Erp\Bundle\ReportBundle\Domain\CQRS\VatExpenseReportQuery as QueryInterface;

class VatExpenseReportQueryService implements QueryInterface
{
    ...
    function vatExpenseQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->vatExpenseQueryBuilder('_entity');
