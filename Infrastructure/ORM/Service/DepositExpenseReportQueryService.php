...
use Erp\Bundle\ReportBundle\Domain\CQRS\DepositExpenseReportQuery as QueryInterface;

class DepositExpenseReportQueryService implements QueryInterface
{
    ...
    function depositExpenseQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->depositExpenseQueryBuilder('_entity');
