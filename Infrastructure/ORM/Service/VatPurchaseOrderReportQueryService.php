...
use Erp\Bundle\ReportBundle\Domain\CQRS\VatPurchaseOrderReportQuery as QueryInterface;

class VatPurchaseOrderReportQueryService implements QueryInterface
{
    ...
    function vatPurchaseOrderQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->vatPurchaseOrderQueryBuilder('_entity');
