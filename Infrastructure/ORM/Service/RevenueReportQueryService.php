...
use Erp\Bundle\ReportBundle\Domain\CQRS\RevenueReportQuery as QueryInterface;
class RevenueReportQueryService implements QueryInterface
{
    ...
    function expenseQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->expenseQueryBuilder('_entity');
