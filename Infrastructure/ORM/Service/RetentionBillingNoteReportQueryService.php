...
use Erp\Bundle\ReportBundle\Domain\CQRS\RetentionBillingNoteReportQuery as QueryInterface;

class RetentionBillingNoteReportQueryService implements QueryInterface
{
    ...
    function retentionBillingNoteQueryBuilder($alias)
    {
