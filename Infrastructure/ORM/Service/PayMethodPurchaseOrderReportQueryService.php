...
use Erp\Bundle\ReportBundle\Domain\CQRS\PayMethodPurchaseOrderReportQuery as QueryInterface;

class PayMethodPurchaseOrderReportQueryService implements QueryInterface
{
    ...
    function payMethodPurchaseOrderQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->payMethodPurchaseOrderQueryBuilder('_entity');
