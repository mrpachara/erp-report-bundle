...
use Erp\Bundle\ReportBundle\Domain\CQRS\RetentionTaxInvoiceReportQuery as QueryInterface;

class RetentionTaxInvoiceReportQueryService implements QueryInterface
{
    ...
    function retentionTaxInvoiceQueryBuilder($alias)
    {
    ...
    {
        $filterDetail = [];
        $qb = $this->retentionTaxInvoiceQueryBuilder('_entity');
