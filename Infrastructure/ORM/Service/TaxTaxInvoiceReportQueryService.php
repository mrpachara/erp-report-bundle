...
use Erp\Bundle\ReportBundle\Domain\CQRS\TaxTaxInvoiceReportQuery as QueryInterface;

class TaxTaxInvoiceReportQueryService implements QueryInterface
{
    ...
    function taxTaxInvoiceQueryBuilder($alias)
    {
